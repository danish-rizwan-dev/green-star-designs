...
export const metadata: Metadata = {
  title: "Contact Us",
  description: "Contact Green Star Designs & Construction  for a free consultation. Based in Bettiah, Bihar. Call +91 7358331731 or email greenstardesignbth@gmail.com.",
  openGraph: {
